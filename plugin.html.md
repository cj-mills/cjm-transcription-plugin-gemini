...
def GeminiPluginConfig(
    ...
    response_mime_type:str='text/plain', downsample_audio:bool=False, downsample_rate:int=16000, downsample_channels:int=1,
    safety_settings:str='OFF', auto_refresh_models:bool=True, model_filter:List=<factory>, use_file_upload:bool=False,
...
```
    ...
    Configuration fields:
      ...
      model_filter: Keywords to exclude from model names (e.g., ['tts', 'image']) (default: <dataclasses._MISSING_TYPE object at 0x7f9de41424d0>)
